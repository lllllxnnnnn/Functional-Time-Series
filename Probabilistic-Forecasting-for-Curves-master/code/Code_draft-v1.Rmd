...
# 读数据
# getwd()
load("/Users/utility/Desktop/DisserDraft/EDF_cleaned.RData")
head(data_All)
# 把数据存进excel
write.csv(data_All,"/Users/utility/Desktop/DisserDraft/EDF_cleaned.csv")
# 给第一列改名字?
```
...
我写的文案
# let's start with the first group (labeled with V1) with 50 households in this group and then record the group averaged curve here.
Dataa <- Dataaa[,c(3,2,1)]
```
